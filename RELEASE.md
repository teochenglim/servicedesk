...
| [v1.0.11](RELEASE/v_1.0.11.md) | Persona UX redesign: per-role home screens, Sudo-as, AI/KB | Not started |
| [v2.0.0](RELEASE/v_2.0.0.md) | Webhooks + MTTx metrics integration | Partially built now (webhooks + MTTx histograms via v1.0.10); dashboards not started |
| [v3.0.0](RELEASE/v_3.0.0.md) | AI/Agent collaboration | Superseded by v1.0.11 (see that file) |
