...
| [v2.0.0](RELEASE/v_2.0.0.md) | Webhooks + MTTx metrics integration | Built — see file for exact scope (trend chart explicitly optional, not done) |
| [v2.1.0](RELEASE/v_2.1.0.md) | Knowledge Base feedback loop + Service catalog | Built — see file for exact scope (suggestion popups/external sync explicitly deferred); `VERSION` not yet bumped from 2.0.0 |
| [v3.0.0](RELEASE/v_3.0.0.md) | Quick-wins backlog | Not started |
